  ...
  */
  constructor(options, getStoreConfig) {
      ...
      loadPromise = new Promise((resolve) => {
        this.startTransition(async () => {
          try {
            ...
            const nextStatusCode = redirect2 ? redirect2.status : notFound ? 404 : this.stores.activeMatchesSnapshot.get().some((d) => d.status === "error") ? 500 : 200;
            this.batch(() => {
    ...
    this.preloadRoute = async (opts) => {
      ...
      const activeMatchIds = /* @__PURE__ */ new Set([...this.stores.matchesId.get(), ...this.stores.pendingMatchesId.get()]);
      const loadedMatchIds = /* @__PURE__ */ new Set([...activeMatchIds, ...this.stores.cachedMatchesId.get()]);
...
var useTags = (assetCrossOrigin) => {
  ...
  return buildTagsFromMatches(router, nonce, router.stores.activeMatchesSnapshot.get(), assetCrossOrigin);
};
...
const appCss = "/artisan-bakery-suite/assets/styles-BYAvM_Mr.css";
...
const $$splitComponentImporter = () => import("./index-BK0vF09m.js");
const Route2 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Handcrafted French pastries, artisan breads, and signature cakes since 1987. Visit our boutique bakery in Paris."
    }, {
      property: "og:title",
      content: "Maison Dorée — Artisan Bakery & Pâtisserie"
    }, {
      property: "og:description",
      content: "Handcrafted French pastries, artisan breads, and signature cakes since 1987."
    }]
  })
});
